...
epochs <- c(data$X)
train_total_loss <- c(data$train_total_his)
train_loss <- c(data$train_his)
val_total_loss <- c(data$val_total_his)
...
loss_type <- c(rep("train_loss", time=81), rep("val_loss", times=81))#, rep("train_total_loss", time=81), rep("val_total_loss", times=81))
train_val_loss <- c(train_loss, val_loss)#, train_total_loss, val_total_loss)
