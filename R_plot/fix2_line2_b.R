...
#name <- "noaug/1p_vgg16_pt30-4"
#name <- "noaug/1p_vgg19_pt30-4"

#name <- "noaug/2p_vgg16_pt30-4"
#name <- "noaug/2p_vgg19_pt30-4"

#name <- "noaug/2p_vgg16_lda_pt30-4"
#name <- "noaug/2p_vgg19_lda_pt30-4"

#name <- "aug/1p_vgg16_aug_pt30-4"
#name <- "aug/1p_vgg19_aug_pt30-4"

#name <- "aug/2p_vgg16_aug_pt30-4"
#name <- "aug/2p_vgg19_aug_pt30-4"

#name <- "aug/2p_vgg16_lda_aug_pt30-4"
name <- "aug/2p_vgg19_lda_aug_pt30-4"
...
sp <- sp + coord_fixed(ratio=360/1) + scale_y_continuous(limits=c(0.05, 0.12), breaks=c(train_loss_minBreak, 0.065, val_loss_minBreak, 0.08, 0.1, 0.12, 0.14, 0.16, 0.18, 0.2, 0.24)) + 
